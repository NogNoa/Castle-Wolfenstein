...
#define SegMemSet(A, b)    (_seg_memset((int) (A) >> 8, (char *) (A), (byte) b))
#define WSegMem_Set(A, w)  {(SegMemSet(A, w));   (SegMemSet(A+1, w >> 8));}
#define LSeg_Mem_Set(A, l) {{WSegMem_Set(A, l)} {WSegMem_Set(A+2, l >> 8)}}

#define SegMemGet(A)       (_seg_memget((int) (A) >> 8, (char *) (A)))
